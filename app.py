...
:root {
  --bg:        #03050a;        /* Change from #070b14 to #03050a (darker) */
  --surface:   #080c14;        /* Change from #0d1424 to #080c14 (darker) */
  --surface2:  #0a0f1a;        /* Change from #111827 to #0a0f1a (darker) */
  --border:    rgba(255,255,255,0.04);  /* Change from 0.06 to 0.04 */
  --border2:   rgba(255,255,255,0.08);  /* Change from 0.12 to 0.08 */
}
