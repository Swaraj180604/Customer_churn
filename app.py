...
.section-label {
  ...
  text-transform: uppercase; color: var(--muted);
  margin: 1.2rem 0 0.6rem; padding-bottom: 0.5rem;
  border-bottom: 1px solid var(--border);
}
...
label, .stSlider label { color: #94a3b8 !important; font-size: 0.78rem !important; }
...
with right:
    ...
    with tab2:
        ...
        feat_vals   = [f[1] * 100 for _, f in top_features]
