...
with right:
    ...
    st.markdown(f"""
        <div class="card" style="margin-top: 1rem; transition: all 0.2s;">
          <!-- Account Info -->
          <div class="section-label" style="margin-top: 0;">
            <span style="width: 3px; height: 16px; background: var(--accent); border-radius: 2px; display: inline-block; margin-right: 0.4rem;"></span>
            Account Info
          </div>
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem 1.5rem; margin-bottom: 1.5rem;">
            <div><div class="stat-lbl">Age</div><div class="stat-val" style="font-size: 1.2rem;">{age}</div></div>
            <div><div class="stat-lbl">Service Calls</div><div class="stat-val" style="font-size: 1.2rem;">{csc}</div></div>
            <div><div class="stat-lbl">Tenure (months)</div><div class="stat-val" style="font-size: 1.2rem;">{tenure}</div></div>
            <div><div class="stat-lbl">Data Usage (GB)</div><div class="stat-val" style="font-size: 1.2rem;">{data_usage:.2f}</div></div>
          </div>
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem 1.5rem; margin-bottom: 1.5rem;">
            <div><div class="stat-lbl">Monthly Charges ($)</div><div class="stat-val" style="font-size: 1.2rem;">{monthly:.2f}</div></div>
            <div><div class="stat-lbl">Total Charges ($)</div><div class="stat-val" style="font-size: 1.2rem;">{total:.2f}</div></div>
          </div>
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem 1.5rem;">
            <div><div class="stat-lbl">Contract Type</div><div class="stat-val" style="font-size: 1.1rem; font-weight: 600;">{contract}</div></div>
            <div><div class="stat-lbl">Payment Method</div><div class="stat-val" style="font-size: 1.1rem; font-weight: 600;">{payment}</div></div>
            <div><div class="stat-lbl">Internet Service</div><div class="stat-val" style="font-size: 1.1rem; font-weight: 600;">{internet}</div></div>
            <div><div class="stat-lbl">Tech Support</div><div class="stat-val" style="font-size: 1.1rem; font-weight: 600;">{tech_support}</div></div>
            <div><div class="stat-lbl">Online Security</div><div class="stat-val" style="font-size: 1.1rem; font-weight: 600;">{online_security}</div></div>
          </div>
        </div>
        """, unsafe_allow_html=True)
